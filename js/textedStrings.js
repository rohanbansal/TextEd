...
en.ageRegistration = function(name) { return ("Hello " + name + "! How old are you?"); }
en.nextReminderMsg = function(user) { return ("Hello " + user.name + "! Your next reminder is: " + user.nextReminder); }
en.reminderMsg = function(user) { return ("Hello " + user.name + " - please remember to take your medication today!"); }
